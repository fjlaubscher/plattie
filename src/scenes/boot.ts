...
class BootScene extends Phaser.Scene {
  ...
  private createLoadingGraphics(): void {
    ...
    this._loadingBar.fillStyle(Colors.primaryLight, 1);
  ...
  public preload(): void {
    ...
    this.cameras.main.setBackgroundColor(Colors.primaryLight);
    ...
    this.load.on(
      ...
      (value: number) => {
        if (this._progressBar) {
          ...
          this._progressBar.fillStyle(Colors.primary, 1);
    ...
    // load our package
    this.load.pack('assets', '/game/assets.json');
  }
